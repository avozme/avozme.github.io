---
layout: page
title: 2.6 Cookies y variables de sesión
...
### 2.6.2. Manejando cookies con PHP
...
### 2.6.4. Abrir sesiones: session_start()
...
### 2.6.5. Usar variables de sesión: $_SESSION
...
### 2.6.6. Eliminar variables de sesión: unset() y session_destroy()
...
### 2.6.7. Control de acceso a las aplicaciones web
...
### 2.6.8. Autenticación mediante ACL

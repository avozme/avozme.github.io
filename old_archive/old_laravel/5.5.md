---
layout: page
title: 3.5 Artisan, la consola que mola
...
## 3.5. Artisan, la consola que mola
{: .no_toc }
...
### 3.5.1. ¿Qué es Artisan y cómo se utiliza?
...
### 3.5.2. Un ejemplo práctico: crear un controlador
...
### 3.5.4. Comandos principales de Artisan

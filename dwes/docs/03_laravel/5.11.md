---
layout: page
title: 3.11 Usando la BD con Eloquent
permalink: /laravel/eloquent-old.html
nav_order: 11
has_children: false
parent: 3 (OLD) Aplicaciones SSR con Laravel
grand_parent: Desarrollo Web en Entorno Servidor
---

## 3.11. Usando la BD con Eloquent
{: .no_toc }
...
### 3.11.1. ¿Qué es el mapeo objeto-relacional?
...
### 3.11.2. ¿Cómo puedo usar Eloquent en mi aplicación?
...
### 3.11.3. Pero ¿cómo sabe Laravel qué tabla está asociada a ese modelo?
...
### 3.11.5. Inserciones y borrados con Eloquent
...
### 3.11.6. Lista de los métodos más útiles de Eloquent
...
### 3.11.7. Relaciones entre tablas con Eloquent
...
#### 3.11.7.1. Relaciones 1:1 (usuarios <-> emails)
...
#### 3.11.7.2. Relaciones 1:N (usuarios <-> artículos)

...
### 3.10.1. Crear tablas mediante las migraciones
...
### 3.10.2. Modificar tablas mediante migraciones
...
### 3.10.3. Otras operaciones en las migraciones
...
### 3.10.5. Lista de comandos superútiles para manejar migraciones

...
## 2.4. Interacción con la base de datos
{: .no_toc }
...
### 2.4.1. MySQL/MariaDB con PHP clásico (¡Ojo! ¡Obsoleto!)
...
### 2.4.2. MySQL/MariaDB con PHP moderno: la extensión PDO

Ahora se utiliza **una biblioteca de clases para acceder a los diferentes SGBDs**.

Todos los nuevos desarrollos deberían usar las bibliotecas de clases y prescindir de las viejas librerías de funciones.

Aunque PHP ofrece varios mecanismos, como la clase **MySQLi**, el estándar profesional en la actualidad es **PDO**:

**La extensión PDO (PHP Data Objects) es una clase genérica que permite acceder a cualquier gestor de bases de datos mediante el mismo conjunto de métodos. Es lo que se llama una *capa de abstracción de acceso a datos***.
...
### 2.4.3. Inserción, modificación y borrado de datos con PDO
...
### 2.4.5. Mejorando la implementación de consultas
...
2. **Utiliza *`<?= ... ?>`***. Esto, como ya vimos,  es una abreviatura muy habitual de *`<?php echo("...") ?>`*.

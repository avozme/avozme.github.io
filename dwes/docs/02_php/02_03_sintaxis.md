...
### 2.3.12. Entrada de datos a través de formulario
...
La variable *$_REQUEST* sirve tanto para POST como para GET. Sin embargo, se desaconseja usarla porque es más lenta y puede plantear problemas de seguridad.

### 2.3.13. Validación y saneamiento de formularios

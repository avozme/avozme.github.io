...
**Layout** es una forma genérica de referirse al diseño de capas del interfaz de usuario de una aplicación. Es decir, el layout es el diseño de los elementos del interfaz de usuario.
...
Vamos a construir un master layout de ejemplo. Será muy simple, pero más adelante puedes complicarlo todo lo que quieras, y afectará a todas las vistas de tu aplicación:

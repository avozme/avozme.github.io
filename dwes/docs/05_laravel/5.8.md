...
Laravel ya trae dos archivos (*app.css* y *app.js*) basados en **Boostrap** para empezar a trabajar. Para usarlos, basta con añadir esto a la cabecera de nuestras vistas:

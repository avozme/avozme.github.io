---
layout: page
title: 7. Introducción a la programación
...
## 7.1. ¿Qué es exactamente eso de "programar un ordenador"?
...
### 7.1.6. Expresiones y operadores
...
### 7.1.6. Dos maneras formales de escribir los algoritmos: pseudocódigo y diagramas de flujo
...
### 7.2.1. Qué es y qué no es el pseudocódigo
...
### 7.2.2. Instrucciones típicas en pseudocódigo (versión PSeInt)
...
### 7.2.3. Un ejemplo sencillo de algoritmo escrito en pseudocódigo
...
### 7.3.1. Simbología de los diagramas de flujo
...
## 7.4. Errores frecuentes entre principiantes

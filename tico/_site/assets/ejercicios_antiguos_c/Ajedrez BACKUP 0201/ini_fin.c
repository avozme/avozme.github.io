...
void valores_iniciales(Tcasilla tablero[9][9], Testado* estado)
{
  ...
  estado->torre_blanca_movida = FALSO;
  estado->torre_negra_movida = FALSO;
...
// ---------------------------------------------------------------------------------------
void elegir_jugadores(char* jug_blanco, char* jug_negro)
{
  // Hasta que no se programen las funciones de inteligencia artificial,
  // los jugadores serán exclusivamente humanos
  *jug_blanco = HUMANO;
  *jug_negro = HUMANO;
}

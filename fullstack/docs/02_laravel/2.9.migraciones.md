...
**Paso 1**: Inicializar el sistema de migraciones de Laravel (**¡no es necesario en versiones modernas de Laravel!**). Si ya lo hemos hecho antes, nos dará un error al intentar hacerlo otra vez:
